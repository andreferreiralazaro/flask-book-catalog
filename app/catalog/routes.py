from app.catalog import main # importando o blueprint
from app import db
...
def edit_book(book_id):
    book = Book.query.get(book_id)
    form=EditBookForm(obj=book)     # obj=book mostrará os dados do livro já no formulário
...
def create_book(pub_id):
    form = CreateBookForm()
    form.pub_id.data = pub_id   # pré-popula pub_id
